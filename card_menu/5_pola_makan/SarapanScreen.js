...
export default function SarapanScreen({ navigation }) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (breakfastSched && breakfastSched.meal_time !== '-') {
          ...
          setHour(h);
          setMinute(m);
          setNotifEnabled(breakfastSched.notif_enabled === 1);
        }
      }
    } catch (e) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Menu Sarapan</Text>
        <View style={{ width: 24 }} />
      </View>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.notifToggleRow}>
              <View style={styles.notifToggleTextCol}>
                ...
                <Text style={styles.notifToggleDesc}>Dapatkan push notification pada jam sarapan</Text>
              </View>
              <Switch
                value={notifEnabled}
