      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.headerRow}>
          <View style={styles.header}>
            ...
            <Text style={[styles.subtitle, isDarkMode && { color: '#94A3B8' }]}>
              Kenali suasana hati dan temukan ketenangan.
            </Text>
          </View>
        ...
        <View style={[styles.card, isDarkMode && { backgroundColor: '#1E293B', borderColor: '#334155' }]}>
          ...
          <View style={styles.modeSelector}>
            ...
            >
              <Text style={[styles.modeBtnText, breathingMode === 'Tidur' && styles.modeBtnTextActive]}>
                Tidur (4-7-8)
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
            ...
            >
              <Text style={[styles.modeBtnText, breathingMode === 'Cepat' && styles.modeBtnTextActive]}>
                Cepat (1m)
              </Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.breathingDisplay}>
            ...
            <Text style={[styles.breathInstructionSmall, isDarkMode && { backgroundColor: '#0F172A', color: '#60A5FA' }]}>
        ...
        <View style={[styles.card, isDarkMode && { backgroundColor: '#1E293B' }]}>
          ...
          <Text style={[styles.subCardTitle, isDarkMode && { color: '#94A3B8' }]}>
            Berdasarkan tingkat stres Anda (Tingkat Stres: {stressLevel})
          </Text>
          ...
          <TouchableOpacity style={styles.aiSuggestion} onPress={() => alert('Mengarahkan ke halaman Olahraga')}>
            ...
            <View style={styles.aiContent}>
              <Text style={[styles.aiTitle, isDarkMode && { color: '#F8FAFC' }]}>Butuh gerak?</Text>
              <Text style={[styles.aiDesc, isDarkMode && { color: '#94A3B8' }]}>
                Coba olahraga ringan 10 menit untuk melepas endorfin!
              </Text>
            </View>
          ...
          >
            ...
            <View style={styles.aiContent}>
              ...
              <Text style={[styles.aiDesc, isDarkMode && { color: '#94A3B8' }]}>
                Coba ngemil buah pisang atau yoghurt sebagai camilan sehat.
              </Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#9CA3AF" />
          </TouchableOpacity>
